 ...
 */
 ...
 /*
  * Plugin modified to allow callback when video is ready.
  */
    ...
    return this.each(function(i) {
      ...
      // player init and update methods
        ...
        onYouTubePlayerReady = function( videoId ) {
          ...
          /*
           * Added to provide a hook for invoking actions when player is ready,
           * such as starting the movie on load.
           */
          options.callback();
        };
