 ...
 *
 * This plugin overlays a list of webmail options when the user
 * hovers over a mailto link. The original link remains unchanged
 * (ie: It will still open the default mail client).
 */
      ...
      var initContextMenu = function() {
        ...
        var windowOpenFunc = function( url ) {
          return function() {
            ...
            window.open(url, '_blank', 'location=0,statusbar=0,menubar=0,width=600,height=600');
            return false;
          };
        };   
